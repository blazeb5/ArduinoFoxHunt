/*
  ...
  Updated Jun 2025, KI5SXE IDE 2.3.6
  The purpose of this sketch is to use your Baofeng UV5R (Kenwood plug) or other radio
...
#define rest 60000       //the amount of time between transmits in ms 60000=60seconds
...
String Text = "KI5SXE FOX KI5SXE FOX";                   //This is what will be transmitted
String code = formMorse(Text);
String easterEgg = "KI5SXE Fox found Fox Found KI5SXE";  //This will be transmitted instead if pin 10 is held high at reset.
